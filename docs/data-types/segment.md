...
The biggest difference between this and a [`line`]({{ site.baseurl }}/data-types/line/) is that its composition is based on two points.
...
The column is automatically identified and its value turned into what is defined in [`geometry.segment_class`]({{ site.baseurl }}/getting-started/configuring/#geometry.segment_class) or into a `Torque::PostgreSQL::Segment`. 
